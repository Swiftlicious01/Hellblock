...
/**
 * Represents a holder for the Schematic GUI inventory. This class is used to
 * associate the Schematic GUI's inventory with an object.
 */
public class SchematicGUIHolder implements InventoryHolder {
