...
/**
 * Represents a holder for the Flags GUI inventory. This class is used to
 * associate the Flags GUI's inventory with an object.
 */
public class FlagsGUIHolder implements InventoryHolder {
