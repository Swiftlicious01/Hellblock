...
/**
 * Represents a holder for the Island Choice GUI inventory. This class is used to
 * associate the Island Choice GUI's inventory with an object.
 */
public class IslandChoiceGUIHolder implements InventoryHolder {
