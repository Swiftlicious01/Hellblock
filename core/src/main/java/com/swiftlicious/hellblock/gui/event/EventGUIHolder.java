...
/**
 * Represents a holder for the Event GUI inventory. This class is used to
 * associate the Event GUI's inventory with an object.
 */
public class EventGUIHolder implements InventoryHolder {
