...
/**
 * Represents a holder for the Reset Confirm GUI inventory. This class is used
 * to associate the Reset Confirm GUI's inventory with an object.
 */
public class ResetConfirmGUIHolder implements InventoryHolder {
