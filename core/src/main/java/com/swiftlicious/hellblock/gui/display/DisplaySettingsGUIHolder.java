...
/**
 * Represents a holder for the DisplaySettings GUI inventory. This class is used
 * to associate the DisplaySettings GUI's inventory with an object.
 */
public class DisplaySettingsGUIHolder implements InventoryHolder {
