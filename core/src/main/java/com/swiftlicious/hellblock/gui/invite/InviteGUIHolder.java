...
/**
 * Represents a holder for the Invite GUI inventory. This class is used to
 * associate the Invite GUI's inventory with an object.
 */
public class InviteGUIHolder implements InventoryHolder {
