...
/**
 * Represents a holder for the Visit GUI inventory. This class is used to
 * associate the Visit GUI's inventory with an object.
 */
public class VisitGUIHolder implements InventoryHolder {
