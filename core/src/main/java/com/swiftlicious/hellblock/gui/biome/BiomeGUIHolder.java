...
/**
 * Represents a holder for the Biome GUI inventory. This class is used
 * to associate the Biome GUI's inventory with an object.
 */
public class BiomeGUIHolder implements InventoryHolder {
