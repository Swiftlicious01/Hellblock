...
/**
 * Represents a holder for the Notification GUI inventory. This class is used to
 * associate the Notification GUI's inventory with an object.
 */
public class NotificationGUIHolder implements InventoryHolder {
