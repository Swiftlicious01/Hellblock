...
public class HellblockCuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
	 ...
	 */
	public HellblockCuboid(String identifier, Location l1, Location l2) {
	...
	/**
	 * Construct a Cuboid given the bounding box object which represents the overall
	 * bounds of the Cuboid.
	 * 
	 * @param worldName - the world's name
	 * @param bounds    - the bounds of the entire area
	 */
	public HellblockCuboid(String identifier, String worldName, BoundingBox bounds) {
		this.identifier = identifier;
		this.worldName = worldName;
		this.x1 = (int) Math.min(bounds.getMinX(), bounds.getMaxX());
		this.y1 = (int) Math.min(bounds.getMinY(), bounds.getMaxY());
		this.z1 = (int) Math.min(bounds.getMinZ(), bounds.getMaxZ());
		this.x2 = (int) Math.max(bounds.getMinX(), bounds.getMaxX());
		this.y2 = (int) Math.max(bounds.getMinY(), bounds.getMaxY());
		this.z2 = (int) Math.max(bounds.getMinZ(), bounds.getMaxZ());
	}
	 ...
	 */
	public HellblockCuboid(String identifier, Location l1) {
		this(identifier, l1, l1);
	}
	 ...
	 */
	public HellblockCuboid(HellblockCuboid other) {
		this(other.identifier, other.getWorld().getName(), other.x1, other.y1, other.z1, other.x2, other.y2, other.z2);
	}
	 ...
	 */
	public HellblockCuboid(String identifier, World world, int x1, int y1, int z1, int x2, int y2, int z2) {
		this.identifier = identifier;
	 ...
	 * @param z2        - Z co-ordinate of corner 2
	 */
	private HellblockCuboid(String identifier, String worldName, int x1, int y1, int z1, int x2, int y2, int z2) {
		this.identifier = identifier;
		this.worldName = worldName;
		this.x1 = Math.min(x1, x2);
		this.x2 = Math.max(x1, x2);
	 ...
	 */
	public HellblockCuboid(Map<String, Object> map) {
	 ...
	 */
	public HellblockCuboid expand(CuboidDirection dir, int amount) {
		switch (dir) {
		case North:
			return new HellblockCuboid(this.identifier, this.worldName, this.x1 - amount, this.y1, this.z1, this.x2,
					this.y2, this.z2);
		case South:
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1, this.z1, this.x2 + amount,
					this.y2, this.z2);
		case East:
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1, this.z1 - amount, this.x2,
					this.y2, this.z2);
		case West:
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2,
					this.z2 + amount);
		case Down:
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1 - amount, this.z1, this.x2,
					this.y2, this.z2);
		case Up:
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1, this.z1, this.x2,
					this.y2 + amount, this.z2);
		default:
	 ...
	 */
	public HellblockCuboid shift(CuboidDirection dir, int amount) {
	 ...
	 */
	public HellblockCuboid outset(CuboidDirection dir, int amount) {
		HellblockCuboid c;
		switch (dir) {
		case Horizontal:
	 ...
	 */
	public HellblockCuboid inset(CuboidDirection dir, int amount) {
	 ...
	 */
	public HellblockCuboid contract() {
	 ...
	 */
	public HellblockCuboid contract(CuboidDirection dir) {
		HellblockCuboid face = getFace(dir.opposite());
		switch (dir) {
		case Down:
			...
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1, this.z1, this.x2,
					face.getUpperY(), this.z2);
		case Up:
			while (face.containsOnly(Material.AIR) && face.getUpperY() < this.getUpperY()) {
				face = face.shift(CuboidDirection.Up, 1);
			}
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, face.getLowerY(), this.z1, this.x2,
					this.y2, this.z2);
		case North:
			while (face.containsOnly(Material.AIR) && face.getLowerX() > this.getLowerX()) {
				face = face.shift(CuboidDirection.North, 1);
			}
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1, this.z1, face.getUpperX(),
					this.y2, this.z2);
		case South:
			while (face.containsOnly(Material.AIR) && face.getUpperX() < this.getUpperX()) {
				face = face.shift(CuboidDirection.South, 1);
			}
			return new HellblockCuboid(this.identifier, this.worldName, face.getLowerX(), this.y1, this.z1, this.x2,
					this.y2, this.z2);
		case East:
		...
		case West:
			...
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1, face.getLowerZ(), this.x2,
					this.y2, this.z2);
		default:
			throw new IllegalArgumentException("Invalid direction " + dir);
		}
	 ...
	 */
	public HellblockCuboid getFace(CuboidDirection dir) {
		switch (dir) {
		case Down:
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1, this.z1, this.x2, this.y1,
					this.z2);
		case Up:
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y2, this.z1, this.x2, this.y2,
					this.z2);
		case North:
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1, this.z1, this.x1, this.y2,
					this.z2);
		case South:
			return new HellblockCuboid(this.identifier, this.worldName, this.x2, this.y1, this.z1, this.x2, this.y2,
					this.z2);
		case East:
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1, this.z1, this.x2, this.y2,
					this.z1);
		case West:
			return new HellblockCuboid(this.identifier, this.worldName, this.x1, this.y1, this.z2, this.x2, this.y2,
					this.z2);
		default:
			throw new IllegalArgumentException("Invalid direction " + dir);
		}
	 ...
	 */
	public HellblockCuboid getBoundingCuboid(HellblockCuboid other) {
		if (other == null)
			return this;
		...
		return new HellblockCuboid(this.identifier, this.worldName, xMin, yMin, zMin, xMax, yMax, zMax);
	}
	...
	@Override
	public HellblockCuboid clone() {
		return new HellblockCuboid(this);
	}

	@Override
	public String toString() {
		return new String("HellblockCuboid: " + this.worldName + "," + this.x1 + "," + this.y1 + "," + this.z1 + "=>"
