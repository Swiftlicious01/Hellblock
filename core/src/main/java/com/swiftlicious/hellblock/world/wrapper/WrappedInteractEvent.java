...
public class WrappedInteractEvent {
	...
	public WrappedInteractEvent(ExistenceForm existenceForm, Player player, HellblockWorld<?> world,
			Location clickedLocation, String relatedID, ItemStack itemInHand, String itemID, EquipmentSlot hand,
			BlockFace blockFace, Cancellable event) {
		this.player = player;
		this.world = world;
