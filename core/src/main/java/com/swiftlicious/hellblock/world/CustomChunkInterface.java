 ...
 */
public interface CustomChunkInterface {
	 ...
	 *
	 * @return A {@link Stream} of {@link CustomSection} to save.
	 */
	@NotNull
	Stream<CustomSection> sectionsToSave();
	 ...
	 *
	 * @param sectionID The ID of the section to retrieve.
	 * @return The {@link CustomSection} instance.
	 */
	CustomSection getSection(int sectionID);

	/**
	 * Retrieves all sections within this chunk.
	 *
	 * @return An array of {@link CustomSection}.
	 */
