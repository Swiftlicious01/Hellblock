 ...
 * the x, y, and z coordinates, with the x and z limited to the range [0, 15]
 * (as they represent positions within a 16x16 chunk), and y representing the
 * height.
 */
public class BlockPos {
	...
	/**
	 * Converts this BlockPos into a Pos3 object, calculating absolute world
	 * coordinates using the provided ChunkPos.
	 *
	 ...
	 *
	 * @return The section ID, representing which 16-block high section of the world
	 *         the position is in.
	 */
	 ...
	 * @return true if the object is a BlockPos with the same encoded position,
	 *         false otherwise.
	 */
	@Override
