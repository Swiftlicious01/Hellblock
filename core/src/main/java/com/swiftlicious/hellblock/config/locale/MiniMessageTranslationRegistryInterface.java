...
public interface MiniMessageTranslationRegistryInterface extends Translator {

	static @NotNull MiniMessageTranslationRegistryInterface create(final Key name, final MiniMessage miniMessage) {
		return new MiniMessageTranslationRegistry(requireNonNull(name, "name"),
	...
	default void registerAll(final @NotNull Locale locale, final @NotNull Set<String> keys,
