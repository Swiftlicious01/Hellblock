...
public class UtilConfigParser {
	...
	public EventCarrier getEventCarrier() {
		final EventCarrier.Builder builder = EventCarrierInterface.builder().id(id).type(MechanicType.UTIL);
		eventBuilderConsumers.forEach(consumer -> consumer.accept(builder));
		return builder.build();
	}

	public EffectModifier getEffectModifier() {
		final EffectModifier.Builder builder = EffectModifierInterface.builder().id(id);
