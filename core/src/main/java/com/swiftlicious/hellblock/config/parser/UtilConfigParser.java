...
public class UtilConfigParser {
	...
	public EventCarrier getEventCarrier() {
		EventCarrier.Builder builder = EventCarrierInterface.builder().id(id).type(MechanicType.UTIL);
	...
	public EffectModifier getEffectModifier() {
		EffectModifier.Builder builder = EffectModifierInterface.builder().id(id);
