...
/**
 * The EventCarrier interface represents an object that carries events. It
 * defines methods to trigger actions based on specific triggers and contexts.
 */
public interface EventCarrierInterface {
	 ...
	 *
	 * @param context the context of the event, typically containing information
	...
	/**
	 * Triggers actions based on the given context, trigger, and action occurrence
	 * times.
	 *
	 * @param context       the context of the event, typically containing
	 *                      information about the player involved.
	 * @param trigger       the trigger that activates the actions.
	 * @param previousTimes the number of times the action has been triggered
	 *                      before.
	...
	static Builder builder() {
		return new EventCarrier.Builder();
	}

	/**
	 * The Builder interface provides a fluent API for constructing EventCarrier
	 * instances.
	 */
	interface BuilderInterface {
		 ...
		 */
		Builder actionMap(Map<ActionTrigger, Action<Player>[]> actionMap);
		 ...
		 *
		 * @param actionTimesMap the map of actions associated with their triggers and
		 *                       occurrence times.
		 * @return the Builder instance.
		 */
		Builder actionTimesMap(Map<ActionTrigger, TreeMap<Integer, Action<Player>[]>> actionTimesMap);

		/**
		 * Associates a TreeMap of actions with a specific trigger and occurrence times.
		 *
		 * @param trigger the trigger that activates the actions.
		 * @param actions the TreeMap of actions to be triggered at specific occurrence
		 *                times.
		 * @return the Builder instance.
		 */
