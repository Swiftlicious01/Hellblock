...
/**
 * A generic class representing a tuple with three values. This class provides
 * methods for creating and accessing tuples with three values.
 *
...
public record Tuple<L, M, R>(L left, M mid, R right) {
	...
	/**
	 * Creates a new {@link Tuple} with the specified left, middle, and right
	 * values.
	 *
