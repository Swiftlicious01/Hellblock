 ...
 * and methods for managing and retrieving mechanic types by ID.
 */
public class MechanicType {

	private static final Map<String, List<MechanicType>> types = new HashMap<>();
	...
	private static final MechanicType[] VALUES = new MechanicType[] { LOOT, ROD, UTIL, BAIT, HOOK, ENCHANT };
