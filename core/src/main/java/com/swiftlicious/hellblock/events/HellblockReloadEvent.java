package com.swiftlicious.hellblock.events;
 ...
 * reloaded.
 */
public class HellblockReloadEvent extends Event {
	...
	/**
	 * Constructs a new HellblockReloadEvent.
	 *
	 * @param plugin The instance of the Hellblock plugin that is being reloaded
	 */
	public HellblockReloadEvent(HellblockPlugin plugin) {
		this.plugin = plugin;
	}
