...
public class WildStackerHook implements Listener {
	...
	public static void register() {
		Bukkit.getPluginManager().registerEvents(new WildStackerHook(), HellblockPlugin.getInstance());
	}

	@EventHandler(priority = EventPriority.HIGHEST, ignoreCancelled = true)
	public void onStackMob(com.bgsoftware.wildstacker.api.events.EntityStackEvent event) {
		LivingEntity living = event.getEntity().getLivingEntity();
