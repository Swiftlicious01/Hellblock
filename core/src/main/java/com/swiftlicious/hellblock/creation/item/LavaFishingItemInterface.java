...
import com.swiftlicious.hellblock.creation.item.LavaFishingItem.Builder;
import com.swiftlicious.hellblock.player.Context;
import com.swiftlicious.hellblock.utils.extras.MathValue;
import com.swiftlicious.hellblock.utils.extras.PriorityFunction;

/**
 * Interface representing a lava fishing item
 */
public interface LavaFishingItemInterface {

	String DEFAULT_MATERIAL = "PAPER";

	/**
	 * Returns the material type of the lava fishing item.
	 *
	...
	/**
	 * Returns the unique identifier of the lava fishing item.
	 *
	...
	/**
	 * Builds the lava fishing item using the given context.
	 *
	...
	/**
	 * Creates a new {@link Builder} instance to construct a
	 * {@link LavaFishingItem}.
	 *
	 * @return a new {@link Builder} instance.
	 */
	static Builder builder() {
		return new LavaFishingItem.Builder();
	}

	/**
	 * Builder interface for constructing instances of {@link LavaFishingItem}.
	 */
	interface BuilderInterface {

		/**
		 * Sets the unique identifier for the {@link LavaFishingItem} being built.
		 *
		...
		/**
		 * Sets the material type for the {@link LavaFishingItem} being built.
		 *
		...
		/**
		 * Sets the list of tag consumers for the {@link LavaFishingItem} being built.
		 * Tag consumers are functions that take an {@link Item} and a {@link Context}
		...
		/**
		 * Builds and returns a new {@link LavaFishingItem} instance.
		 *
		 * @return a new {@link LavaFishingItem} instance.
		 */
		LavaFishingItem build();
	}
}