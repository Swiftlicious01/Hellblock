...
/**
 * Interface representing an item. This interface provides methods for managing
 * item properties such as custom model data, damage, display name, lore,
 * enchantments, and tags.
 *
...
public interface Item<I> {
	 ...
	 *
	 * @return an {@link Optional} containing the custom model data, or empty if not
	 *         set
	 */
	 ...
	 *
	 * @return an {@link Optional} containing the maximum damage value, or empty if
	 *         not set
	 */
