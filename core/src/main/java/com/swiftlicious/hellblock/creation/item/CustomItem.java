...
public class CustomItem implements CustomItemInterface {
	...
	public CustomItem(String id, String material, MathValue<Player> amount,
	...
	public static class Builder implements BuilderInterface {
		...
		public CustomItem build() {
			return new CustomItem(requireNonNull(id), material, amount,
