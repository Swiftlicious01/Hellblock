...
/**
 * EffectModifier interface for modifying effects. This interface allows
 * defining conditions and modifications for effects applied to players.
 */
public interface EffectModifierInterface {
	...
	/**
	 * Returns an array of requirements that must be met by a Player for the effect
	 * to be applied.
	 *
	...
	/**
	 * Returns a list of modifiers that apply changes to an effect within a given
	 * context.
	 *
	...
	/**
	 * Creates and returns a new Builder instance for constructing EffectModifier
	 * instances.
	 *
	 * @return a new Builder instance
	 */
	static Builder builder() {
		return new EffectModifier.Builder();
	}
