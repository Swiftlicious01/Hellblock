...
public class FishingEffect implements Effect {
	...
	public FishingEffect(double waitTime, double waitTimeMultiplier, double difficulty, double difficultyMultiplier) {
	 ...
	 *
	 * @param weightModifierIgnored A list of pairs representing ignored weight
	 *                              modifiers to add.
	 * @return The FishingEffect instance for method chaining.
	 */
	...
	public void merge(Effect another) {
		if (another == null)
			return;
		if (another.canLavaFishing())
			this.lavaFishing = true;
