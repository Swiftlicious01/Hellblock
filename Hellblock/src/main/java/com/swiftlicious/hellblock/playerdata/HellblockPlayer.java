...
public class HellblockPlayer {
	...
	public void loadHellblockPlayer() {
		...
		if (this.hasHellblock) {
			...
			if (this.getHellblockPlayer().contains("player.party") && !this.getHellblockPlayer().getStringList("player.party").isEmpty()) {
			...
			if (this.hellblockParty != null)
				this.hellblockParty.clear();
		}
