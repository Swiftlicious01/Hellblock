...
public class ReflectionUtils {
	...
	public static void load() {
		...
		try {
			...
			iChatComponentMethod = HellblockPlugin.getInstance().getVersionManager().isSpigot() ? MinecraftReflection.getChatSerializerClass().getMethod("a",
					MinecraftReflection.getIChatBaseComponentClass(),
					MinecraftReflection.getHolderLookupProviderClass()) : MinecraftReflection.getChatSerializerClass().getMethod("a", String.class);
