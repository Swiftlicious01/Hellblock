...
public class MiniMessageTranslationRegistry implements Examinable, MiniMessageTranslationRegistryInterface {
	private final Key name;
	private final Map<String, Translation> translations = new ConcurrentHashMap<>();
	private Locale defaultLocale = Locale.US;
	private final MiniMessage miniMessage;

	MiniMessageTranslationRegistry(final Key name, final MiniMessage miniMessage) {
		this.name = name;
	...
	public static class ArgumentTag implements TagResolver {
		...
		public @Nullable Tag resolve(final @NotNull String name, final @NotNull ArgumentQueue arguments,
			...
			final int index = arguments.popOr("No argument number provided").asInt()
	...
	final class Translation implements Examinable {
		...
		@Nullable
		String translate(final @NotNull Locale locale) {
