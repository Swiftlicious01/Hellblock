...
public class UserData implements UserDataInterface {
	...
	public UserData(String name, UUID uuid, EarningData earningData, ChallengeData challengeData,
	...
	public static class Builder implements BuilderInterface {
		...
		public UserData build() {
			return new UserData(this.name, this.uuid, this.earningData, this.challengeData, this.hellblockData,
					this.locationCacheData, this.isLocked);
		}
	}
