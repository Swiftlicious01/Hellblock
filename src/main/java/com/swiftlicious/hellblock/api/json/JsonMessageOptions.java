...
/**
 * class for easy setting of options for and creation of
 * {@link JsonMessageConverter} objects
 */
public final class JsonMessageOptions {
	...
	/**
	 * @return the current state whether suggesting a command or chat text on click
	 *         is allowed or not
	 */
	...
	/**
	 * @return the current state whether running a command or sending a chat message
	 *         on click is allowed or not
	 */
	public boolean run() {
		return run;
	}
	...
	/**
	 * set whether the allowing to suggest a command or chat on click is activated,
	...
	/**
	 * set whether the allowing to run a command or chat on click is activated,
	 * default is {@code true}
	 *
	...
	/**
	 * set whether the availability to embed a link is activated, default is
	 * {@code true}
	 *
	...
	/**
	 * @return a newly created {@link JsonMessageConverter} if at least one option
	 *         is changed from default, otherwise it returns
	 *         {@link JsonMessageConverter#DEFAULT}
	 */
